...
export default function Main() {
  const apiUrl = "https://port-0-sy-cheerio-2rrqq2blmlvy0fh.sel5.cloudtype.app"; //https://port-0-sy-cheerio-2rrqq2blmlvy0fh.sel5.cloudtype.app
          ...
          <div className="con_box">
            ...
            {targetData ? (
              <>
                ...
                {targetData.info?.casting?.length > 0 && (
                  <>
